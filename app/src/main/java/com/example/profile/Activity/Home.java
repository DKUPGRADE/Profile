...
//                    }
                    ...
                    Toast.makeText(Home.this, "Unable to update", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    public void getdata() {
        ...
        call.enqueue(new Callback<List<Profile>>() {
            public void onFailure(@NonNull Call<List<Profile>> call, @NonNull Throwable th) {
                ...
                Toast.makeText(Home.this, "All set err", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onResponse(@NonNull Call<List<Profile>> call, @NonNull Response<List<Profile>> response) {
                ...
                Glide.with(Home.this).load(response.body().get(0).getImage_url()).into(circleImageView);
...
//                imageuri = data.getData();
                ...
                selectedImage = FileUtils.getPath(Home.this, image);
                uploadFileToServer();
...
//                profile.setImageBitmap(bitmap);
    ...
    public Uri getImageUri(Bitmap inImage) {
        ...
        String path = MediaStore.Images.Media.insertImage(getContentResolver(), inImage, ts, null);
...
//        Call<FileModel> call = service.callUploadApi(filePart);
        call.enqueue(new Callback<FileModel>() {
            ...
            public void onResponse(@NotNull Call<FileModel> call, @NotNull Response<FileModel> response) {
                ...
                Toast.makeText(Home.this, fileModel.getMessage(), Toast.LENGTH_SHORT).show();
            }
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "https://www.upgradeinfotech.in/projects/ModesToolbox/v1.1/user_profile_name_update.php", new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response.equals("Updated successfully")) {
                    ...
                    pd.cancel();
                    Toast.makeText(Home.this, "Data Add", Toast.LENGTH_SHORT).show();

                } else {
                    pd.cancel();
                    Toast.makeText(Home.this, "Data Not Add", Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Home.this, "Data Fail", Toast.LENGTH_SHORT).show();
                pd.cancel();
                    ...
                    Glide.with(Home.this)
                            ...
                            .listener(new RequestListener<Drawable>() {
                                ...
                                public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
                                    ...
                                    Toast.makeText(Home.this, "Upadte error" + e, Toast.LENGTH_SHORT).show();
                                    return false;
                                }
...
//                        saveImage(((BitmapDrawable) resource).getBitmap());
                            ...
                            .into(profile);
                    pd.cancel();
                    Toast.makeText(Home.this, "image Add", Toast.LENGTH_SHORT).show();

                } else {
                    Toast.makeText(Home.this, "image Not Add", Toast.LENGTH_SHORT).show();
